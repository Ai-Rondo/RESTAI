...
const principles = [
  ...
  { icon: Layers, title: "We organize the signals.", text: "Restaurant Technology Solutions becomes the visibility layer above your existing restaurant software." },
    ...
    <section className="solution-section" id="solution">
      <div className="section-shell">
        <div className="section-heading">
          ...
          <p>
            Restaurant Technology Solutions connects to or organizes the information your teams already produce, then presents
